...
for (ethical_a, ethical_b) in ethical_a_b_list:
    ...
    for oc in ocs:
        ...
        d_p_infection_burden = p_infection_burden_1 - p_infection_burden_2
        ...
        plot_df.append(
            {
                ...
                "delta_p_infburd": d_p_infection_burden,
                "loss": tmp_loss,
...
myvars_list = [["p_infburd_2", "p_infburd_1", "delta_p_infburd"],
          ["loss_tcb", "loss_eib", "loss_evb"],
          ["tcb", "teib", "tevb"]]

mylabels_list = [["per-capita infection burden (group 2)", "per-capita infection burden (group 1)", "difference (p1 - p2)"],
