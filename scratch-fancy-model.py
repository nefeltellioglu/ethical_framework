...
from ethics.model import OptParams, BurdenParams, SIRParams, SIRSolution, optimal_initial_conditions, loss_clinical_burden, loss_equity_of_burden, loss_equity_of_vaccination, sir_vacc, sir_vacc_SSA
...
#Hospitilised - adverse - given vaccination: days_hosp_vacc * prop_hosp_vacc
#Hospitilised - infection - no vaccination: days_hosp_inf * prop_hosp_inf
#Hospitilised - infection - given vaccination: days_hosp_inf * prop_hosp_inf * (1 - vacc_protection_dis)
#########
...
disease_burden_params = BurdenParams(
                        ...
                        prop_hosp_vacc_1= 0.004,
                        prop_hosp_vacc_2= 0.002,
