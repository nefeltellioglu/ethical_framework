...
# enforce contact reciprocity: 
synthetic_contact_nsw_reci <- synthetic_contact_nsw

#1 to 1
synthetic_contact_nsw_reci[1, 3] <- synthetic_contact_nsw[1, 3]
#1 to 2
synthetic_contact_nsw_reci[2, 3] <- (synthetic_contact_nsw[2, 3] + synthetic_contact_nsw[3, 3]) / 2
#2 to 1
synthetic_contact_nsw_reci[3, 3] <- (synthetic_contact_nsw[2, 3] + synthetic_contact_nsw[3, 3]) / 2
#2 to 2
synthetic_contact_nsw_reci[4, 3] <- synthetic_contact_nsw[4, 3]
...
# 
# synthetic_contact_nsw[1,3] <- synthetic_contact_nsw[1,3]/(sevmi/(sevmi+sevpl))
# synthetic_contact_nsw[2,3] <- synthetic_contact_nsw[2,3]/(sevmi/(sevmi+sevpl))
# synthetic_contact_nsw[3,3] <- synthetic_contact_nsw[3,3]/(sevpl/(sevmi+sevpl))
# synthetic_contact_nsw[4,3] <- synthetic_contact_nsw[4,3]/(sevpl/(sevmi+sevpl))

synthetic_contact_nsw_reci[1,3] <- synthetic_contact_nsw_reci[1,3]/(sevmi/(sevmi+sevpl))
synthetic_contact_nsw_reci[2,3] <- synthetic_contact_nsw_reci[2,3]/(sevpl/(sevmi+sevpl))
synthetic_contact_nsw_reci[3,3] <- synthetic_contact_nsw_reci[3,3]/(sevmi/(sevmi+sevpl))
synthetic_contact_nsw_reci[4,3] <- synthetic_contact_nsw_reci[4,3]/(sevpl/(sevmi+sevpl))

synthetic_contact_nsw_reci[1,3] <- synthetic_contact_nsw_reci[1,3]/(sevmi/(sevmi+sevpl))
synthetic_contact_nsw_reci[2,3] <- synthetic_contact_nsw_reci[2,3]/(sevmi/(sevmi+sevpl))
synthetic_contact_nsw_reci[3,3] <- synthetic_contact_nsw_reci[3,3]/(sevpl/(sevmi+sevpl))
synthetic_contact_nsw_reci[4,3] <- synthetic_contact_nsw_reci[4,3]/(sevpl/(sevmi+sevpl))


synthetic_contact_nsw_reci
