...
def loss_clinical_burden(
    sir_sols: [SIRSolution], disease_burden_params: BurdenParams
) -> float:
...
def loss_equity_of_burden(
    ...
    for sir_sol in sir_sols:
        ...
        ttl_pop = sir_sol.total_population()
        obs_burden_1_novacc = (
            disease_burden_params.prop_hosp_inf_1
            * disease_burden_params.days_hosp_inf_1
...
def loss_equity_of_vaccination(
    sir_sols: [SIRSolution], disease_burden_params: BurdenParams
) -> float:
    # ttl_vacc = sir_sol.total_vaccinated()
    # ttl_pop = sir_sol.total_population()
...
def sir_vacc_SSA(
    params: SIRParams, sir_0: SIRInitialCondition, opt_params: OptParams, ts
) -> [SIRSolution]:
    y0 = [
        sir_0.s0_1,
        sir_0.s0_2,
    ...
    class SIR2(gillespy2.Model):
        def __init__(self, y0, params, pop_size_1, pop_size_2, t):
            ...
            # Define parameters
            beta_11 = gillespy2.Parameter(
                name="beta_11", expression=params.beta_11 / pop_size_1
            )
            beta_12 = gillespy2.Parameter(
                name="beta_12", expression=params.beta_12 / pop_size_2
            )
            beta_21 = gillespy2.Parameter(
                name="beta_21", expression=params.beta_21 / pop_size_1
            )
            beta_22 = gillespy2.Parameter(
                name="beta_22", expression=params.beta_22 / pop_size_2
            )
            gamma = gillespy2.Parameter(name="gamma", expression=params.gamma)

            self.add_parameter([beta_11, beta_12, beta_21, beta_22, gamma])

            # unvaccinated  I infect unvaccinated S
            inf_11 = gillespy2.Reaction(
                name="inf_11",
                rate=beta_11,
                reactants={s_1: 1, i_1: 1},
                products={i_1: 2},
            )
            inf_12 = gillespy2.Reaction(
                name="inf_12",
                rate=beta_12,
                reactants={s_2: 1, i_1: 1},
                products={i_1: 1, i_2: 1},
            )
            inf_21 = gillespy2.Reaction(
                name="inf_21",
                rate=beta_21,
                reactants={s_1: 1, i_2: 1},
                products={i_1: 1, i_2: 1},
            )
            inf_22 = gillespy2.Reaction(
                name="inf_22",
                rate=beta_22,
                reactants={s_2: 1, i_2: 1},
                products={i_2: 2},
            )
            rec_1 = gillespy2.Reaction(
                name="rec_1", rate=gamma, reactants={i_1: 1}, products={r_1: 1}
            )
            rec_2 = gillespy2.Reaction(
                name="rec_2", rate=gamma, reactants={i_2: 1}, products={r_2: 1}
            )

            # vaccinated unprotected I (Ivu) infect unvaccinated S (S)
            inf_1vu1 = gillespy2.Reaction(
                name="inf_1vu1",
                rate=beta_11,
                reactants={s_1: 1, i_1_vu: 1},
                products={i_1: 1, i_1_vu: 1},
            )
            inf_1vu2 = gillespy2.Reaction(
                name="inf_1vu2",
                rate=beta_12,
                reactants={s_2: 1, i_1_vu: 1},
                products={i_2: 1, i_1_vu: 1},
            )
            inf_2vu1 = gillespy2.Reaction(
                name="inf_2vu1",
                rate=beta_21,
                reactants={s_1: 1, i_2_vu: 1},
                products={i_1: 1, i_2_vu: 1},
            )
            inf_2vu2 = gillespy2.Reaction(
                name="inf_2vu2",
                rate=beta_22,
                reactants={s_2: 1, i_2_vu: 1},
                products={i_2: 1, i_2_vu: 1},
            )

            # unvaccinated I infect vaccinated unprotected S (Svu)
            inf_11vu = gillespy2.Reaction(
                name="inf_11vu",
                rate=beta_11,
                reactants={s_1_vu: 1, i_1: 1},
                products={i_1_vu: 1, i_1: 1},
            )
            inf_12vu = gillespy2.Reaction(
                name="inf_12vu",
                rate=beta_12,
                reactants={s_2_vu: 1, i_1: 1},
                products={i_2_vu: 1, i_1: 1},
            )
            inf_21vu = gillespy2.Reaction(
                name="inf_21vu",
                rate=beta_21,
                reactants={s_1_vu: 1, i_2: 1},
                products={i_1_vu: 1, i_2: 1},
            )
            inf_22vu = gillespy2.Reaction(
                name="inf_22vu",
                rate=beta_22,
                reactants={s_2_vu: 1, i_2: 1},
                products={i_2_vu: 1, i_2: 1},
            )

            # vaccinated unprotected I (Ivu) infect vaccinated unprotected S (Svu)
            inf_1vu1vu = gillespy2.Reaction(
                name="inf_1vu1vu",
                rate=beta_11,
                reactants={s_1_vu: 1, i_1_vu: 1},
                products={i_1_vu: 2},
            )
            inf_1vu2vu = gillespy2.Reaction(
                name="inf_1vu2vu",
                rate=beta_12,
                reactants={s_2_vu: 1, i_1_vu: 1},
                products={i_2_vu: 1, i_1_vu: 1},
            )
            inf_2vu1vu = gillespy2.Reaction(
                name="inf_2vu1vu",
                rate=beta_21,
                reactants={s_1_vu: 1, i_2_vu: 1},
                products={i_1_vu: 1, i_2_vu: 1},
            )
            inf_2vu2vu = gillespy2.Reaction(
                name="inf_2vu2vu",
                rate=beta_22,
                reactants={s_2_vu: 1, i_2_vu: 1},
                products={i_2_vu: 2},
            )

            # recovery from vu
            rec_1_vu = gillespy2.Reaction(
                name="rec_1_vu", rate=gamma, reactants={i_1_vu: 1}, products={r_1_vu: 1}
            )
            rec_2_vu = gillespy2.Reaction(
                name="rec_2_vu", rate=gamma, reactants={i_2_vu: 1}, products={r_2_vu: 1}
            )
    ...
    results = model.run(
        number_of_trajectories=opt_params.no_runs, algorithm=opt_params.model_type
    )
...
def objective_func_factory(
    ...
    def objective(vacc_props: list) -> float:
        ...
        if opt_params.model_type == "ODE":
            ...
            loss_equity_of_burden1 = loss_equity_of_burden(
                sir_sols, disease_burden_params
            )
            loss_equity_of_vaccination1 = loss_equity_of_vaccination(
                sir_sols, disease_burden_params
            )
...
def optimal_initial_conditions(
    ...
    objective = objective_func_factory(
        params,
